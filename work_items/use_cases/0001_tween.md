## Summary
[+]_Buy a Gift for a Tween_[/+][-] _<!-- Insert Title Here -->_[/-]
[-]_Buy a Gift for a Tween_[/-]
[+]### Driving User Story[/+]
[-]### Driving User Story[/-]
[+]**As a [primary actor],** As her uncle,[/+]
[+]**I want [an action or feature],** I want to buy a gift for my niece's 12th birthday.[/+][-] **As a [primary actor],** As her uncle,[/-]
[+]**With [additional requirement or side-effect],** not knowing what she likes and without involving her parents.[/+][-] **I want [an action or feature],** I want to buy a gift for my niece's 12th birthday.[/-]
[+]**So that [a reason or benefit].** So that the gift is something she will find special.[/+][-] **With [additional requirement or side-effect],** not knowing what she likes and without involving her parents.[/-]
...
[+]Optionally, mark one actor as primary. -->[/+][-] <!-- Enumerate every actor, server, service, process that will take an action or reaction, including storage, forwarding, etc.[/-]
[+]Niece[/+][-] Optionally, mark one actor as primary. -->[/-]
[+]Uncle[/+][-] Niece[/-]
[+]Uncle's personal AI agent[/+][-] Uncle[/-]
[+]Social media sites - Instagram, Facebook, TikTok, ...[/+][-] Uncle's personal AI agent[/-]
[+]Shopping services[/+][-] Social media sites - Instagram, Facebook, TikTok, ...[/-]
[-]Shopping services[/-]
[+]### Other Stakeholders[/+]
[-]### Other Stakeholders[/-]
[+]<!-- e.g. auditors, regulators, forensic accountants, martian anthropologists, etc. -->[/+]
[+]Her parents[/+][-] <!-- e.g. auditors, regulators, forensic accountants, martian anthropologists, etc. -->[/-]
Her[+] friends[/+][-] parents[/-]
[-]Her friends[/-]
[+]## Flows[/+]
[-]## Flows[/-]
...
[+]It examines her social media and that of her friends.[/+][-] I ask my AI agent to find out what she likes.[/-]
[+]My agent presents me with a few options.[/+][-] It examines her social media and that of her friends.[/-]
[+]I select one of them.[/+][-] My agent presents me with a few options.[/-]
[+]The agent attempts to make the purchase at one or more online sites.[/+][-] I select one of them.[/-]
[+]If it cannot, it tells me why (out of stock, too expensive, won't arrive in time).[/+][-] The agent attempts to make the purchase at one or more online sites.[/-]
[+]Tries to buy the next item.[/+][-] If it cannot, it tells me why (out of stock, too expensive, won't arrive in time).[/-]
...
[+]My niece has social media accounts.[/+][-] I have a personal AI agent.[/-]
[+]AI agent can get access to controlled social media account of a tween.[/+][-] My niece has social media accounts.[/-]
AI agent can[+] make purchases on my behalf.[/+][-] get access to controlled social media account of a tween.[/-]
[-]AI agent can make purchases on my behalf.[/-]
[+]### 1 - Trigger[/+]
[-]### 1 - Trigger[/-]
[+]<!-- What (user or system) event or action initiates this use case? -->[/+]
[+]He uncle asks the AI to find, purchase, and ship her gift.[/+][-] <!-- What (user or system) event or action initiates this use case? -->[/-]
...
[+]Feel free to not just list these at a high level, but name these and add a #### heading for each, now or later -->[/+][-] <!-- Can be failure modes/conditions or just more qualitative issues that affect satisfaction/safety less definitively.[/-]
[-]Feel free to not just list these at a high level, but name these and add a #### heading for each, now or later -->[/-]
...
[+]To put it another way, what observable behaviors or metrics can be used to detect a failure more, or differentiate happy paths-or-outcomes from less-happy paths-or-outcomes? -->[/+][-] <!-- What conditions or criteria must be met for this use case to be considered successfully handled? What limitations are acceptable?[/-]
