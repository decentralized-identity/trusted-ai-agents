...
- Announcements:
        ...
        - 
    - Tom (in chat): i read NIST AI 200-2 (an RFI from a few days ago with 60day response time) with some concern that it does not consider open-weight models or policy generated by the user - i think they should here from us -
        - Erik will start, we can all join in via [] https://docs.google.com/document/d/1TNf3wlHSYg9-hzVbzdtcz8z3edlp_A8SMFKNlmhOoxE/edit?tab=t.0#heading=h.w17yrrmau8wb
